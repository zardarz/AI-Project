...
public class AnimalController : MonoBehaviour
{
    ...
    private void MoveAnimal() {
        ...
        rb.MovePosition(rb.position + (Vector2) transform.forward * outputLayer.GetNode(0).GetActivation()); // move the animal forward based on the output of the first node
